...
/*
 * OAIAuthnMeMemberRead.h
 *
 * 
 */

#ifndef OAIAuthnMeMemberRead_H
#define OAIAuthnMeMemberRead_H
...
class OAIAuthnMeMemberRead : public OAIObject {
public:
    OAIAuthnMeMemberRead();
    OAIAuthnMeMemberRead(QString json);
    ~OAIAuthnMeMemberRead() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAuthnMeMemberRead)

#endif // OAIAuthnMeMemberRead_H
