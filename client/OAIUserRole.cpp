...
QString OAIUserRole::getTenant() const {
    return tenant;
}
void OAIUserRole::setTenant(const QString &tenant) {
    this->tenant = tenant;
    this->m_tenant_isSet = true;
}

bool OAIUserRole::is_tenant_Set() const{
    return m_tenant_isSet;
}

bool OAIUserRole::is_tenant_Valid() const{
