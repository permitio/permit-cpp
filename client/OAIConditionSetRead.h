...
/*
 * OAIConditionSetRead.h
 *
 * 
 */

#ifndef OAIConditionSetRead_H
#define OAIConditionSetRead_H
...
namespace OpenAPI {
class OAIResourceRead;

class OAIConditionSetRead : public OAIObject {
public:
    OAIConditionSetRead();
    OAIConditionSetRead(QString json);
    ~OAIConditionSetRead() override;
    ...
    OAIResourceRead getResource() const;
    void setResource(const OAIResourceRead &resource);
...
Q_DECLARE_METATYPE(OpenAPI::OAIConditionSetRead)

#endif // OAIConditionSetRead_H
