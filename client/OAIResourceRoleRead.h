...
/*
 * OAIResourceRoleRead.h
 *
 * 
 */

#ifndef OAIResourceRoleRead_H
#define OAIResourceRoleRead_H
...
class OAIResourceRoleRead : public OAIObject {
public:
    OAIResourceRoleRead();
    OAIResourceRoleRead(QString json);
    ~OAIResourceRoleRead() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceRoleRead)

#endif // OAIResourceRoleRead_H
