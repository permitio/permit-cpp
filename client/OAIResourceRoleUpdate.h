...
/*
 * OAIResourceRoleUpdate.h
 *
 * 
 */

#ifndef OAIResourceRoleUpdate_H
#define OAIResourceRoleUpdate_H
...
class OAIResourceRoleUpdate : public OAIObject {
public:
    OAIResourceRoleUpdate();
    OAIResourceRoleUpdate(QString json);
    ~OAIResourceRoleUpdate() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIResourceRoleUpdate)

#endif // OAIResourceRoleUpdate_H
