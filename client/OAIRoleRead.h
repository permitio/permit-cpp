...
#ifndef OAIRoleRead_H
#define OAIRoleRead_H
...
class OAIRoleRead : public OAIObject {
public:
    OAIRoleRead();
    OAIRoleRead(QString json);
    ~OAIRoleRead() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIRoleRead)
